...
worker_processes ENV['RAILS_ENV'] || ENV['RACK_ENV'] || 'production' == "production" ? 1 : 1
...
app = "/www/tgc" # available in 0.94.0+
...
before_fork do |server, worker|
  ...
  # restart every process one by one to prevent the waiting of visiting
  sleep 12
end
